...
def get_args_parser():
    ...
    parser.add_argument('--drop_prob', type=float, default=0.1, help="stochastic depth rate")
...
def train_dino(args):
    ...
    dataset = CamelyonDataset(args.data_path, transform=transform, is_training=True, max_bag_size=1024)
    ...
    if args.arch in vits.__dict__.keys():
        student = vits.__dict__[args.arch](
            ...
            drop_prob=args.drop_prob,  # stochastic depth
        )
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, data_loader,
    ...
    for it, (images, label, slide_id) in enumerate(metric_logger.log_every(data_loader, 10, header)):
...
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number):
        ...
        normalize = transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize((0.6223, 0.4763, 0.6009), (0.2012, 0.2190, 0.1722)),
        ])
